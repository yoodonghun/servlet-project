...
<section class="content">
   <div class="singer d-flex p-4">
	   ...
	   <div>   
	      <h2 class="font-weight-bolder ml-3 mt-3"><%= artistInfo.get("name") %></h2>
	      <div class="font-weight-bolder ml-3 "><%= artistInfo.get("agency") %></div>
	      <div class="font-weight-bolder ml-3 "><%= artistInfo.get("debute") + " " + "데뷔" %></div>
       </div>
     ...
     <div>
       <table class="table text-center">
          ...
          <tbody>
           ...
           <tr>
             <td><%= info.get("id") %></a></td>
             <td><a href="music_template.jsp?id=<%= info.get("id")%>"><%= info.get("title") %></td>
